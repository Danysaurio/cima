...
?>
	...
	<section class="registro">
		<h2 class="center our-title">Registro</h2>
		<div class="container ">
			<div class="section ">
				...
				<form action="#" method="post">
					<div class="row">
						<div class="col s12 m6">
							...
							<input type="text" <?php echo @$holder[5];?> name="ife" id="ife">
						</div>
						<div class="col s12 m6">
							...
							<div class="btn-container">
								<button class="btn waves-effect waves-light btn-registrar" type="submit" name="btn-registrar">Registrar
